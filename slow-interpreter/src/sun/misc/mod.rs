pub mod unsafe_ {
    ...
    impl<'gc_life> Unsafe<'gc_life> {
        pub fn the_unsafe(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> Unsafe<'gc_life> {
        ...
        pub fn object_field_offset(&self, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field: Field<'gc_life>) -> Result<JavaValue<'gc_life>, WasException> {
...
pub mod launcher {
    ...
    impl<'gc_life> Launcher<'gc_life> {
        pub fn get_launcher(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> Result<Launcher<'gc_life>, WasException> {
        ...
        pub fn get_loader(&self, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> Result<ClassLoader<'gc_life>, WasException> {
            let launcher = check_initing_or_inited_class(jvm, int_state, CClassName::launcher().into())?;
            int_state.push_current_operand_stack(JavaValue::Object(self.normal_object.clone().into()));
    ...
    pub mod ext_class_loader {
        ...
        impl<'gc_life> ExtClassLoader<'gc_life> {
            pub fn get_ext_class_loader(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> Result<ExtClassLoader<'gc_life>, WasException> {
