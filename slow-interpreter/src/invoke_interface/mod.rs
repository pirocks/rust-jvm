...
pub fn get_invoke_interface(jvm: &JVMState, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> *const JNIInvokeInterface_ {
...
pub unsafe fn get_interpreter_state_invoke_interface<'l, 'interpreter_guard>(vm: *mut JavaVM) -> &'l mut InterpreterStateGuard<'l> {
