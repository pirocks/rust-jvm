...
pub fn pop2<'gc_life>(jvm: &'gc_life JVMState<'gc_life>, method_id: MethodId, mut current_frame: StackEntryMut) {
...
pub fn pop(mut current_frame: StackEntryMut) { current_frame.pop(PTypeView::LongType); }
