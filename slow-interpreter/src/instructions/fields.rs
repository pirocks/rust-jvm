...
pub fn putstatic(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field_class_name: CClassName, field_name: FieldName, field_descriptor: &CFieldDescriptor) {
...
pub fn putfield(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field_class_name: CClassName, field_name: FieldName, field_descriptor: &CFieldDescriptor) {
...
pub fn get_static(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field_class_name: CClassName, field_name: FieldName, _field_descriptor: &CFieldDescriptor) {
...
fn get_static_impl(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field_class_name: CClassName, field_name: FieldName) -> Result<Option<JavaValue<'gc_life>>, WasException> {
...
pub fn get_field(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, field_class_name: CClassName, field_name: FieldName, _field_desc: &CompressedFieldDescriptor, _debug: bool) {
