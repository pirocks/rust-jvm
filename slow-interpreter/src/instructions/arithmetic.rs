...
pub fn fmul(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn fadd(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    let value1 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    current_frame.push(jvm, JavaValue::Float(value2 + value1));
}

pub fn fdiv(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    let value1 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    current_frame.push(jvm, JavaValue::Float(value1 / value2));
}

pub fn ddiv(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn dmul(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    let value1 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    current_frame.push(jvm, JavaValue::Double(value2 * value1));
}

pub fn dadd(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    let value1 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    current_frame.push(jvm, JavaValue::Double(value2 + value1));
}
...
pub fn dsub(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    let value1 = current_frame.pop(jvm, PTypeView::DoubleType).unwrap_double();
    current_frame.push(jvm, JavaValue::Double(value1 - value2));
}

pub fn fsub(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    let value1 = current_frame.pop(jvm, PTypeView::FloatType).unwrap_float();
    current_frame.push(jvm, JavaValue::Float(value1 - value2));
}

pub fn lmul(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn lneg(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(-first))
}

pub fn land(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let second = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(first & second))
}

pub fn iand(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn ixor(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let second = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int(first ^ second))
}
...
pub fn ior(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let second = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int(first | second))
}
...
pub fn iadd(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let second = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int(((first as i64) + (second as i64)) as i32))
}

pub fn idiv(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn imul(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let second = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int((first as i64 * second as i64) as i32))
}

pub fn ineg(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int((0 - first as i64) as i32))
}


pub fn irem(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let value1 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
...
pub fn ishl(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let value1 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int(value1 << (value2 & 63)));
}

pub fn ishr(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let value1 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    current_frame.push(jvm, JavaValue::Int(value1 >> (value2 & 63)));
}
...
pub fn isub(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn lsub(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
...
pub fn lcmp(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let value1 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    if value1 == value2 {
...
pub fn ladd(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let second = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
...
pub fn ldiv(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let value1 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(value1 / value2));
}

pub fn lrem(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let value1 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(value1 % value2));
}

pub fn lor(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let second = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(first | second));
}

pub fn lxor(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    let second = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(first ^ second));
}

pub fn lshl(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let value1 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
...
pub fn lshr(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
    let value1 = current_frame.pop(jvm, PTypeView::LongType).unwrap_long();
    current_frame.push(jvm, JavaValue::Long(value1 >> ((value2 & 0x7F) as i64)));
}

pub fn lushr(jvm: &'_ JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(jvm, PTypeView::IntType).unwrap_int();
