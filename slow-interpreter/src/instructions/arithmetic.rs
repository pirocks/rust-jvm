...
pub fn ddiv(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(Some(PTypeView::DoubleType)).unwrap_double();
    let value1 = current_frame.pop(Some(PTypeView::DoubleType)).unwrap_double();
...
pub fn lmul(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(Some(PTypeView::LongType)).unwrap_long();
    let second = current_frame.pop(Some(PTypeView::LongType)).unwrap_long();
...
pub fn iand(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let first = current_frame.pop(Some(PTypeView::IntType)).unwrap_int();
    let second = current_frame.pop(Some(PTypeView::IntType)).unwrap_int();
...
pub fn idiv(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(Some(PTypeView::IntType)).unwrap_int();
    let value1 = current_frame.pop(Some(PTypeView::IntType)).unwrap_int();
...
pub fn iushr(int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>) {
    ...
    let value2 = current_frame.pop(Some(PTypeView::IntType)).unwrap_int() as u32;
    let value1 = current_frame.pop(Some(PTypeView::IntType)).unwrap_int() as u32;
...
pub fn isub(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = Wrapping(current_frame.pop(Some(PTypeView::IntType)).unwrap_int());
    let value1 = Wrapping(current_frame.pop(Some(PTypeView::IntType)).unwrap_int());
...
pub fn lsub(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(Some(PTypeView::LongType)).unwrap_long();
    let value1 = current_frame.pop(Some(PTypeView::LongType)).unwrap_long();
...
pub fn lushr(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'gc_life, 'l>) {
    let value2 = current_frame.pop(Some(PTypeView::IntType)).unwrap_int();
    let value1 = current_frame.pop(Some(PTypeView::LongType)).unwrap_long() as u64;
