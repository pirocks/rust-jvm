...
pub fn invoke_interface<'l, 'gc_life>(jvm: &'_ JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>, invoke_interface: InvokeInterface) {
    ...
    let current_frame: StackEntryRef<'gc_life, 'l> = int_state.current_frame();
