...
*/
pub fn invoke_virtual_instruction<'l, 'k : 'l, 'gc_life>(state: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) {
...
pub fn invoke_virtual_method_i<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, expected_descriptor: MethodDescriptor, target_class: Arc<RuntimeClass<'gc_life>>, target_method: &MethodView) -> Result<(), WasException> {
    invoke_virtual_method_i_impl(jvm, int_state, expected_descriptor, target_class, target_method)
}

fn invoke_virtual_method_i_impl<'gc_life, 'l, 'k: 'l>(
    ...
    if target_method.is_signature_polymorphic() {
        ...
        let form: LambdaForm<'gc_life> = method_handle.get_form();
        let vmentry: MemberName<'gc_life> = form.get_vmentry();
...
pub fn call_vmentry<'gc_life, 'l, 'k: 'l>(jvm: &'gc_life JVMState<'gc_life>, interpreter_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, vmentry: MemberName<'gc_life>) -> Result<JavaValue<'gc_life>, WasException> {
...
pub fn setup_virtual_args<'l, 'k : 'l, 'gc_life>(int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, expected_descriptor: &MethodDescriptor, args: &mut Vec<JavaValue<'gc_life>>, max_locals: u16) {
...
*/
pub fn invoke_virtual<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, method_name: &str, md: &MethodDescriptor) -> Result<(), WasException> {
...
pub fn virtual_method_lookup<'l, 'k : 'l, 'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
