...
*/
pub fn invoke_virtual_instruction(state: &mut JVMState, current_frame: Rc<StackEntry>, cp: u16, debug: bool) {
...
pub fn invoke_virtual_method_i(state: &mut JVMState, current_frame: Rc<StackEntry>, expected_descriptor: MethodDescriptor, target_class: Arc<RuntimeClass>, target_method_i: usize, target_method: &MethodInfo, debug: bool) -> () {
...
pub fn invoke_virtual_unparsed(state: &mut JVMState, current_frame: Rc<StackEntry>, method_name: &String, desc: &String, debug: bool) -> () {
...
*/
pub fn invoke_virtual(state: &mut JVMState, current_frame: Rc<StackEntry>, method_name: &String, md: &MethodDescriptor, debug: bool) -> () {
...
pub fn virtual_method_lookup(state: &mut JVMState, current_frame: &Rc<StackEntry>, method_name: &String, md: &MethodDescriptor, c: Arc<RuntimeClass>) -> (Arc<RuntimeClass>, usize) {
