...
pub fn invoke_special<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) {
...
pub fn invoke_special_impl<'gc_life, 'l, 'k: 'l>(
