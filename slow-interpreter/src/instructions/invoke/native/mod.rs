...
pub fn run_native_method<'l, 'k : 'l, 'gc_life>(
...
fn special_call_overrides<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, method_view: &MethodView, mut args: Vec<JavaValue<'gc_life>>) -> Result<Option<JavaValue<'gc_life>>, WasException> {
