...
use crate::{JVMState, NewJavaValue, NewJavaValueHandle, pushable_frame_todo, WasException};
use crate::utils::unwrap_or_npe;

pub fn shouldBeInitialized<'l, 'gc>(jvm: &'gc JVMState<'gc>, int_state: &'_ mut InterpreterStateGuard<'gc,'l>, args: Vec<NewJavaValue<'gc,'_>>) -> Result<NewJavaValueHandle<'gc>, WasException<'gc>> {
