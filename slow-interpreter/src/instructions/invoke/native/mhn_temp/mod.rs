...
///
pub fn Java_java_lang_invoke_MethodHandleNatives_getMembers<'gc_life>(jvm: &'_ JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>, args: Vec<JavaValue<'gc_life>>) -> Result<JavaValue<'gc_life>, WasException> {
...
fn get_matching_fields<'gc_life>(jvm: &'_ JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>, match_name: &Option<String>, rc: Arc<RuntimeClass<'gc_life>>, view: Arc<dyn ClassView>, search_super: bool, search_interface: bool, fd: Option<FieldDescriptor>) -> Result<Vec<MemberName<'gc_life>>, WasException> {
...
fn get_matching_methods<'gc_life>(
