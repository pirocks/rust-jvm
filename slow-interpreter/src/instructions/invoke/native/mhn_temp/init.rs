...
pub fn MHN_init(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, args: Vec<JavaValue<'gc_life>>) -> Result<(), WasException> {
...
pub fn init(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, mname: MemberName<'gc_life>, target: JavaValue<'gc_life>, view: Either<Option<&MethodView>, Option<&FieldView>>, synthetic: bool) -> Result<(), WasException> {
...
fn method_init(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, mname: MemberName<'gc_life>, method: Method<'gc_life>, method_view: Option<&MethodView>, synthetic: bool) -> Result<(), WasException> {
