...
pub mod dynamic {
    ...
    pub fn invoke_dynamic<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) {
        let _ = invoke_dynamic_impl(jvm, int_state, cp);
    }

    fn invoke_dynamic_impl<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) -> Result<(), WasException> {
    ...
    fn desc_from_rust_str<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, desc_str: String) -> Result<JavaValue<'gc_life>, WasException> {
    ...
    fn method_handle_from_method_view<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, method_ref: &MethodHandleView) -> Result<MethodHandle<'gc_life>, WasException> {
...
fn resolved_class<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) -> Result<Option<(Arc<RuntimeClass<'gc_life>>, String, MethodDescriptor)>, WasException> {
...
pub fn find_target_method<'l, 'k : 'l, 'gc_life>(
