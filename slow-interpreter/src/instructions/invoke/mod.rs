...
pub mod dynamic {
    ...
    pub fn invoke_dynamic(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, cp: u16) {
        let _ = invoke_dynamic_impl(jvm, int_state, cp);
    }

    fn invoke_dynamic_impl(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, cp: u16) -> Result<(), WasException> {
    ...
    fn desc_from_rust_str(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, desc_str: String) -> Result<JavaValue<'gc_life>, WasException> {
    ...
    fn method_handle_from_method_view(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, method_ref: &MethodHandleView) -> Result<MethodHandle<'gc_life>, WasException> {
...
fn resolved_class(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, cp: u16) -> Result<Option<(Arc<RuntimeClass<'gc_life>>, MethodName, CMethodDescriptor)>, WasException> {
...
pub fn find_target_method(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, expected_method_name: MethodName, parsed_descriptor: &CMethodDescriptor, target_class: Arc<RuntimeClass<'gc_life>>) -> (u16, Arc<RuntimeClass<'gc_life>>) {
