...
fn load_class_constant<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, c: &ClassPoolElemView) -> Result<(), WasException> {
...
pub fn load_class_constant_by_type<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, res_class_type: PTypeView) -> Result<(), WasException> {
...
fn load_string_constant<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, s: &StringView) {
...
pub fn create_string_on_stack<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, interpreter_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, res_string: String) -> Result<(), WasException> {
...
pub fn ldc2_w(jvm: &'gc_life JVMState<'gc_life>, mut current_frame: StackEntryMut<'l, 'gc_life>, cp: u16) {
...
pub fn ldc_w<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, cp: u16) {
...
pub fn from_constant_pool_entry<'l, 'k : 'l, 'gc_life>(c: &ConstantInfoView, jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>) -> JavaValue<'gc_life> {
    match &c {
