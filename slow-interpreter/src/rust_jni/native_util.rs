...
pub unsafe extern "C" fn get_object_class(env: *mut JNIEnv, obj: jobject) -> jclass {
    ...
    let class_object = match unwrapped.deref() {
        Object::Array(a) => get_or_create_class_object(
            jvm,
            CPDType::Ref(CPRefType::Array(Box::new(a.elem_type.clone()))),
            int_state,
        ),
        Object::Object(o) => {
...
pub unsafe fn get_interpreter_state<'k, 'l, 'interpreter_guard>(
    env: *mut JNIEnv,
...
pub unsafe fn from_object<'gc_life>(
...
pub unsafe fn from_jclass<'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    obj: jclass,
) -> JClass<'gc_life> {
...
pub unsafe fn try_from_jclass<'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    obj: jclass,
