...
pub fn class_object_to_runtime_class(obj: &JClass<'gc_life>, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>) -> Option<Arc<RuntimeClass<'gc_life>>> {
