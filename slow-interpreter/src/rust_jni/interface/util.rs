...
pub fn class_object_to_runtime_class<'gc_life>(obj: &JClass<'gc_life>, jvm: &'_ JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>) -> Option<Arc<RuntimeClass<'gc_life>>> {
