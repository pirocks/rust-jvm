use jvmti_jni_bindings::{
    jboolean, jbyte, jchar, jclass, jdouble, jfieldID, jfloat, jint, jlong, JNIEnv, jobject, jshort,
};
...
pub unsafe extern "C" fn set_boolean_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jboolean,
...
pub unsafe extern "C" fn set_byte_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jbyte,
...
pub unsafe extern "C" fn set_short_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jshort,
...
pub unsafe extern "C" fn set_char_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jchar,
...
pub unsafe extern "C" fn set_int_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jint,
...
pub unsafe extern "C" fn set_long_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jlong,
...
pub unsafe extern "C" fn set_float_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jfloat,
...
pub unsafe extern "C" fn set_double_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jdouble,
...
pub unsafe extern "C" fn set_object_field(
    env: *mut JNIEnv,
    obj: jobject,
    field_id_raw: jfieldID,
    val: jobject,
    ...
    set_field(
        ...
        obj,
        field_id_raw,
        JavaValue::Object(from_object(get_state(env), val)),
    );
}

pub unsafe extern "C" fn set_static_boolean_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jboolean,
...
pub unsafe extern "C" fn set_static_byte_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jbyte,
...
pub unsafe extern "C" fn set_static_short_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jshort,
...
pub unsafe extern "C" fn set_static_char_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jchar,
...
pub unsafe extern "C" fn set_static_int_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jint,
...
pub unsafe extern "C" fn set_static_long_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jlong,
...
pub unsafe extern "C" fn set_static_float_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jfloat,
...
pub unsafe extern "C" fn set_static_double_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jdouble,
...
pub unsafe extern "C" fn set_static_object_field(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
    value: jobject,
...
unsafe fn set_static_field<'gc_life>(
    env: *mut JNIEnv,
    clazz: jclass,
    field_id_raw: jfieldID,
