...
use jvmti_jni_bindings::{
    ...
    jfloat, jfloatArray, jint, jintArray, jlong, jlongArray, JNIEnv, jshort, jshortArray, jsize,
};
...
pub unsafe extern "C" fn get_boolean_array_region(
    env: *mut JNIEnv,
    array: jbooleanArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_byte_array_region(
    env: *mut JNIEnv,
    array: jbyteArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_short_array_region(
    env: *mut JNIEnv,
    array: jshortArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_char_array_region(
    env: *mut JNIEnv,
    array: jcharArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_int_array_region(
    env: *mut JNIEnv,
    array: jintArray,
    start: jsize,
    len: jsize,
...
unsafe fn array_region_integer_types<T: NumCast>(
    env: *mut JNIEnv,
    array: jarray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_float_array_region(
    env: *mut JNIEnv,
    array: jfloatArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_double_array_region(
    env: *mut JNIEnv,
    array: jdoubleArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn get_long_array_region(
    env: *mut JNIEnv,
    array: jlongArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_boolean_array_region(
    env: *mut JNIEnv,
    array: jbooleanArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_byte_array_region(
    env: *mut JNIEnv,
    array: jbyteArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_char_array_region(
    env: *mut JNIEnv,
    array: jcharArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_short_array_region(
    env: *mut JNIEnv,
    array: jshortArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_int_array_region(
    env: *mut JNIEnv,
    array: jintArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_float_array_region(
    env: *mut JNIEnv,
    array: jfloatArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_double_array_region(
    env: *mut JNIEnv,
    array: jdoubleArray,
    start: jsize,
    len: jsize,
...
pub unsafe extern "C" fn set_long_array_region(
    env: *mut JNIEnv,
    array: jdoubleArray,
    start: jsize,
    len: jsize,
...
unsafe fn set_array_region<'gc_life>(
    env: *mut JNIEnv,
    array: jarray,
    start: i32,
    len: i32,
    java_value_getter: &mut dyn FnMut(isize) -> JavaValue<'gc_life>,
) {
    let jvm = get_state(env);
    let int_state = get_interpreter_state(env);
