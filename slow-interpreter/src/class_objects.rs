...
pub fn get_or_create_class_object(jvm: &'gc_life JVMState<'gc_life>, type_: CPDType, int_state: &'_ mut InterpreterStateGuard<'gc_life,'l>) -> Result<GcManagedObject<'gc_life>, WasException> {
