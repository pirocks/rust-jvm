...
pub fn get_or_create_class_object(jvm: &'_ JVMState<'gc_life>,
                                  type_: PTypeView,
...
pub fn get_or_create_class_object_force_loader(jvm: &'_ JVMState<'gc_life>, type_: PTypeView, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>, loader: LoaderName) -> Result<GcManagedObject<'gc_life>, WasException> {
