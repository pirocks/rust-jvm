...
use jvmti_jni_bindings::{
    jboolean, jclass, jfieldID, jint, jobject, jvmtiEnv, jvmtiError, jvmtiError_JVMTI_ERROR_NONE,
};
...
pub unsafe extern "C" fn is_field_synthetic(
    env: *mut jvmtiEnv,
    klass: jclass,
    field: jfieldID,
...
pub unsafe extern "C" fn get_field_modifiers(
    env: *mut jvmtiEnv,
    klass: jclass,
    field: jfieldID,
...
pub unsafe extern "C" fn get_field_name(
    env: *mut jvmtiEnv,
    klass: jclass,
    field: jfieldID,
    ...
    name_ptr.write(
        jvm.native
            ...
            .allocate_cstring(CString::new(name).unwrap()),
    );
    signature_ptr.write(
        jvm.native
            .native_interface_allocations
            .allocate_cstring(CString::new(field_desc).unwrap()),
    );
    jvmtiError_JVMTI_ERROR_NONE
}
...
pub unsafe extern "C" fn get_class_fields(
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetClassFields");
    ...
    fields_ptr.write(libc::calloc(num_fields, size_of::<*mut jfieldID>())
        as *mut *mut jvmti_jni_bindings::_jfieldID);
    for i in 0..num_fields {
        fields_ptr
            .read()
            .add(i)
            .write(new_field_id(jvm, runtime_class.clone(), i))
    }
    jvm.config
        .tracing
