...
use jvmti_jni_bindings::{
    jboolean, jclass, jint, jlocation, jmethodID, jvmtiEnv, jvmtiError, jvmtiError_JVMTI_ERROR_NONE,
};
...
pub unsafe extern "C" fn get_method_name(
    env: *mut jvmtiEnv,
    method: jmethodID,
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetMethodName");
...
pub unsafe extern "C" fn get_arguments_size(
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetArgumentsSize");
    let method_id = from_jmethod_id(method);
    let (rc, i) = jvm
        .method_table
        .read()
...
pub unsafe extern "C" fn get_method_modifiers(
    env: *mut jvmtiEnv,
    method: jmethodID,
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetMethodModifiers");
    let method_id = from_jmethod_id(method);
    let (class, method_i) = jvm
        .method_table
        .read()
...
pub unsafe extern "C" fn get_method_location(
    env: *mut jvmtiEnv,
    method: jmethodID,
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetMethodLocation");
    let method_id = from_jmethod_id(method);
    let (class, method_i) = jvm
        .method_table
        .read()
...
pub unsafe extern "C" fn get_method_declaring_class(
    env: *mut jvmtiEnv,
    method: jmethodID,
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "GetMethodDeclaringClass");
    let method_id = from_jmethod_id(method);
    let runtime_class = jvm
        .method_table
        .read()
        .unwrap()
        .try_lookup(method_id)
    ...
    declaring_class_ptr.write(new_local_ref_public(
...
pub unsafe extern "C" fn is_method_obsolete(
    env: *mut jvmtiEnv,
    _method: jmethodID,
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "IsMethodObsolete");
...
pub unsafe extern "C" fn is_method_synthetic(
    ...
    let tracing_guard = jvm
        .config
        .tracing
        .trace_jdwp_function_enter(jvm, "IsMethodSynthetic");
    let method_id = from_jmethod_id(method);
    let (class, method_i) = jvm
        .method_table
        .read()
