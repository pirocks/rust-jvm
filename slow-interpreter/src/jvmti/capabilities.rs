...
pub unsafe extern "C" fn get_potential_capabilities(env: *mut jvmtiEnv, capabilities_ptr: *mut jvmtiCapabilities) -> jvmtiError {
    ...
    (*capabilities_ptr).set_can_tag_objects(0);
    ...
    (*capabilities_ptr).set_can_access_local_variables(0);
    //     unsigned int can_maintain_original_method_order : 1;
    (*capabilities_ptr).set_can_maintain_original_method_order(0);
    //     unsigned int can_generate_single_step_events : 1;
    (*capabilities_ptr).set_can_generate_single_step_events(0);
    //     unsigned int can_generate_exception_events : 1;
    (*capabilities_ptr).set_can_generate_exception_events(0);
    //     unsigned int can_generate_frame_pop_events : 1;
    (*capabilities_ptr).set_can_generate_frame_pop_events(0);
    //     unsigned int can_generate_breakpoint_events : 1;
    (*capabilities_ptr).set_can_generate_breakpoint_events(0);
    //     unsigned int can_suspend : 1;
    (*capabilities_ptr).set_can_suspend(0);
    ...
    (*capabilities_ptr).set_can_generate_method_entry_events(0);
    //     unsigned int can_generate_method_exit_events : 1;
    (*capabilities_ptr).set_can_generate_method_exit_events(0);
    ...
    (*capabilities_ptr).set_can_generate_monitor_events(0);
    ...
    (*capabilities_ptr).set_can_generate_garbage_collection_events(0);
