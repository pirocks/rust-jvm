use jvmti_jni_bindings::{jint, JVMTI_VERSION_INTERFACE_JVMTI, JVMTI_VERSION_MASK_MAJOR, JVMTI_VERSION_MASK_MICRO, JVMTI_VERSION_MASK_MINOR, jvmtiEnv, jvmtiError, jvmtiError_JVMTI_ERROR_NONE, jvmtiError_JVMTI_ERROR_NULL_POINTER};
