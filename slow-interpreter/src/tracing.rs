...
impl TracingSettings {
    ...
    pub fn trace_monitor_lock(&self, m: &Monitor, jvm: &'_ JVMState<'gc_life>) {
    ...
    pub fn trace_monitor_unlock(&self, m: &Monitor, jvm: &'_ JVMState<'gc_life>) {
