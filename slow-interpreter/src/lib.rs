...
pub fn run_main<'l, 'k : 'l, 'gc_life>(args: Vec<String>, jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>) -> Result<(), Box<dyn Error>> {
...
fn setup_program_args<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, args: Vec<String>) {
    ...
    let arg_array = JavaValue::Object(todo!()/*Some(Arc::new(Array(ArrayObject::new_array(
        jvm,
        int_state,
        arg_strings,
...
fn set_properties<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>) -> Result<(), WasException> {
