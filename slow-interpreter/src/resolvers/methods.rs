...
pub fn resolve_invoke_virtual<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, member_name: MemberName<'gc_life>) -> Result<Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>, WasException> {
    resolve_virtual_impl(jvm, int_state, member_name, false)
}

pub fn resolve_invoke_interface<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, member_name: MemberName<'gc_life>) -> Result<Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>, WasException> {
    resolve_virtual_impl(jvm, int_state, member_name, true)
}

fn resolve_virtual_impl<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, member_name: MemberName<'gc_life>, include_interfaces: bool) -> Result<Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>, WasException> {
...
pub fn resolve_invoke_special<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, member_name: MemberName<'gc_life>) -> Result<Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>, WasException> {
    let method_type = member_name.get_type().cast_method_type();
    let return_type = method_type.get_rtype_as_type(jvm);
    let parameter_types = method_type.get_ptypes_as_types(jvm);
    let method_descriptor = MethodDescriptor { parameter_types, return_type };
...
pub fn resolve_invoke_static<'l, 'k : 'l, 'gc_life>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, member_name: MemberName<'gc_life>, synthetic: &mut bool) -> Result<Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>, WasException> {
    let method_type = member_name.get_type().cast_method_type();
    let return_type = method_type.get_rtype_as_type(jvm);
    let parameter_types = method_type.get_ptypes_as_types(jvm);
    let runtime_class = member_name.get_clazz().as_runtime_class(jvm);
