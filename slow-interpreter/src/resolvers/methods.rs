...
pub fn resolve_invoke_virtual<'l, 'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    member_name: MemberName<'gc_life>,
) -> Result<
    Result<(Method<'gc_life>, u16, Arc<RuntimeClass<'gc_life>>), ResolutionError>,
    WasException,
> {
    resolve_virtual_impl(jvm, int_state, member_name, false)
}

pub fn resolve_invoke_interface<'l, 'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    member_name: MemberName<'gc_life>,
) -> Result<
...
> {
    ...
    let method_descriptor = CMethodDescriptor {
        arg_types,
        return_type,
    };
    ...
    Ok(Ok((
        Method::method_object_from_method_view(jvm, int_state, &res_method_view)?,
        res_method_view.method_i(),
        runtime_class.clone(),
    )))
}

pub fn resolve_invoke_special<'l, 'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    member_name: MemberName<'gc_life>,
) -> Result<
...
pub fn resolve_invoke_static<'l, 'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    member_name: MemberName<'gc_life>,
    synthetic: &mut bool,
