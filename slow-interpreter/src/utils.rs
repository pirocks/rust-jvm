...
pub fn string_obj_to_string<'gc_life>(
    jvm: &'gc_life JVMState<'gc_life>,
    ...
    char::decode_utf16(borrowed_elems.map(|jv| jv.unwrap_char()))
        .collect::<Result<String, _>>()
        .expect("really weird string encountered") //todo so techincally java strings need not be valid so we can't return a rust string and have to do everything on bytes
}

pub fn throw_npe_res<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
...
pub fn throw_npe<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
) -> T {
...
pub fn throw_array_out_of_bounds_res<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    index: jint,
) -> Result<T, WasException> {
...
pub fn throw_array_out_of_bounds<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    index: jint,
) -> T {
...
pub fn throw_illegal_arg_res<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
) -> Result<T, WasException> {
...
pub fn throw_illegal_arg<T: ExceptionReturn>(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
) -> T {
...
pub fn java_value_to_boxed_object(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    java_value: JavaValue<'gc_life>,
