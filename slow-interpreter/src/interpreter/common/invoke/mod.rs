...
pub fn find_target_method<'gc, 'l>(jvm: &'gc JVMState<'gc>, expected_method_name: MethodName, parsed_descriptor: &CMethodDescriptor, target_class: Arc<RuntimeClass<'gc>>) -> (u16, Arc<RuntimeClass<'gc>>) {
