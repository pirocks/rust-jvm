...
pub fn pop2<'gc, 'l, 'k, 'j>(jvm: &'gc JVMState<'gc>, method_id: MethodId, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j>, current_pc: ByteCodeOffset) -> PostInstructionAction<'gc> {
