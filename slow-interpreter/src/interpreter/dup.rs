...
// pub fn dup_x1(jvm: &'gc JVMState<'gc>, mut current_frame: StackEntryMut<'gc, 'l>) {
...
// pub fn dup2(jvm: &'gc JVMState<'gc>, method_id: MethodId, mut current_frame: StackEntryMut<'gc, 'l>) {
//     let current_pc = current_frame.to_ref().pc(jvm);
//     let stack_frames = &jvm.function_frame_type_data.read().unwrap()[&method_id];
