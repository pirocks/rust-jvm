...
pub fn dup<'gc, 'l, 'k, 'j,'h>(jvm: &'gc JVMState<'gc>, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j, 'h>) -> PostInstructionAction<'gc> {
...
pub fn dup_x1<'gc, 'l, 'k, 'j,'h>(jvm: &'gc JVMState<'gc>, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j, 'h>) -> PostInstructionAction<'gc> {
...
pub fn dup_x2<'gc, 'l, 'k, 'j, 'h>(jvm: &'gc JVMState<'gc>, method_id: MethodId, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j, 'h>, current_pc: ByteCodeOffset) -> PostInstructionAction<'gc> {
...
pub fn dup2<'gc, 'l, 'k, 'j, 'h>(jvm: &'gc JVMState<'gc>, method_id: MethodId, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j, 'h>, current_pc: ByteCodeOffset) -> PostInstructionAction<'gc> {
    let stack_frames = &jvm.function_frame_type_data.read().unwrap().no_tops[&method_id];
    let category2 = &stack_frames[&current_pc].is_category_2_no_tops();
...
pub fn dup2_x1<'gc, 'l, 'k, 'j, 'h>(jvm: &'gc JVMState<'gc>, method_id: MethodId, mut current_frame: InterpreterFrame<'gc, 'l, 'k, 'j, 'h>, current_pc: ByteCodeOffset) -> PostInstructionAction<'gc> {
    let stack_frames = &jvm.function_frame_type_data.read().unwrap().no_tops[&method_id];
    let category2 = &stack_frames[&current_pc].is_category_2_no_tops();
    let value1_vtype = if category2[0] {
        RuntimeType::LongType
