pub mod properties {
    ...
    impl<'gc_life> Properties<'gc_life> {
        pub fn set_property(&self, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life>, key: JString<'gc_life>, value: JString<'gc_life>) -> Result<(), WasException> {
