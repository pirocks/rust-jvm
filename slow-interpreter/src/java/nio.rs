pub mod heap_byte_buffer {
    ...
    impl<'gc_life> HeapByteBuffer<'gc_life> {
        pub fn new<'l, 'k : 'l>(jvm: &'gc_life JVMState<'gc_life>, int_state: &'k mut InterpreterStateGuard<'l, 'gc_life>, buf: Vec<jbyte>, off: jint, len: jint) -> Result<Self, WasException> {
