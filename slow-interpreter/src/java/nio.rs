pub mod heap_byte_buffer {
    ...
    impl<'gc_life> HeapByteBuffer<'gc_life> {
        pub fn new(
            ...
            let heap_byte_buffer_class =
                assert_inited_or_initing_class(jvm, CClassName::heap_byte_buffer().into());
