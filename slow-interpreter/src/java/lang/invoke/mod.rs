pub mod method_type {
    ...
    impl<'gc_life> MethodType<'gc_life> {
        ...
        pub fn new(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>, rtype: JClass<'gc_life>, ptypes: Vec<JClass<'gc_life>>, form: MethodTypeForm<'gc_life>, wrap_alt: JavaValue<'gc_life>, invokers: JavaValue<'gc_life>, method_descriptor: JavaValue<'gc_life>) -> MethodType<'gc_life> {
            let method_type = assert_inited_or_initing_class(jvm, CClassName::method_type().into());
...
pub mod method_type_form {
    ...
    impl<'gc_life> MethodTypeForm<'gc_life> {
        ...
        pub fn new(jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life, '_>, arg_to_slot_table: JavaValue<'gc_life>, slot_to_arg_table: JavaValue<'gc_life>, arg_counts: jlong, prim_counts: jlong, erased_type: Option<MethodType<'gc_life>>, basic_type: Option<MethodType<'gc_life>>, method_handles: JavaValue<'gc_life>, lambda_forms: JavaValue<'gc_life>) -> MethodTypeForm<'gc_life> {
