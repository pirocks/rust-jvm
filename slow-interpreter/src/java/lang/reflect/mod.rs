...
fn get_signature(
    ...
    Ok(JString::from_rust(
        jvm,
        int_state,
        Wtf8Buf::from_string(method_view.desc_str().to_str(&jvm.string_pool)),
    )?
        .intern(jvm, int_state)?)
}

fn exception_types_table(
    jvm: &'gc_life JVMState<'gc_life>,
    int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
    method_view: &MethodView,
...
pub mod method {
    ...
    use crate::java::lang::reflect::{
        exception_types_table, get_modifiers, get_signature, parameters_type_objects,
    };
    use crate::java::lang::string::JString;
    ...
    impl<'gc_life> Method<'gc_life> {
        pub fn method_object_from_method_view(
            jvm: &'gc_life JVMState<'gc_life>,
            int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
            method_view: &MethodView,
            ...
            let name = {
                ...
                JString::from_rust(
                    jvm,
                    int_state,
                    Wtf8Buf::from_string(name.0.to_str(&jvm.string_pool)),
                )?
                    .intern(jvm, int_state)?
            };
        ...
        pub fn new_method(
            ...
            let method_class =
                check_initing_or_inited_class(jvm, int_state, CClassName::method().into()).unwrap();
        ...
        pub fn get_clazz(&self, jvm: &'gc_life JVMState<'gc_life>) -> JClass<'gc_life> {
            self.normal_object
                .lookup_field(jvm, FieldName::field_clazz())
                .cast_class()
                .unwrap() //todo this unwrap
        }

        pub fn get_modifiers(&self, jvm: &'gc_life JVMState<'gc_life>) -> jint {
            self.normal_object
                .lookup_field(jvm, FieldName::field_modifiers())
                .unwrap_int()
        }
        ...
        pub fn get_name(&self, jvm: &'gc_life JVMState<'gc_life>) -> JString<'gc_life> {
            self.normal_object
                ...
                .cast_string()
                .expect("methods must have names")
        }

        pub fn parameter_types(&self, jvm: &'gc_life JVMState<'gc_life>) -> Vec<JClass<'gc_life>> {
            self.normal_object
                .lookup_field(jvm, FieldName::field_parameterTypes())
                .unwrap_array()
                .array_iterator(jvm)
        ...
        pub fn get_slot_or_null(&self, jvm: &'gc_life JVMState<'gc_life>) -> Option<jint> {
            let maybe_null = self
                .normal_object
                .lookup_field(jvm, FieldName::field_slot());
        ...
        pub fn get_return_type_or_null(
            &self,
            jvm: &'gc_life JVMState<'gc_life>,
        ) -> Option<JClass<'gc_life>> {
            let maybe_null = self
                .normal_object
                .lookup_field(jvm, FieldName::field_returnType());
            if maybe_null.try_unwrap_object().is_some() {
                if maybe_null.unwrap_object().is_some() {
...
pub mod constructor {
    ...
    const CONSTRUCTOR_SIGNATURE: &str =
    ...
    impl<'gc_life> Constructor<'gc_life> {
        pub fn constructor_object_from_method_view(
            jvm: &'gc_life JVMState<'gc_life>,
            int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
            method_view: &MethodView,
        ...
        pub fn new_constructor(
            ...
            let constructor_class =
                check_initing_or_inited_class(jvm, int_state, CClassName::constructor().into())?;
...
pub mod field {
    ...
    impl<'gc_life> Field<'gc_life> {
        pub fn init(
            ...
            let field_classfile =
                check_initing_or_inited_class(jvm, int_state, CClassName::field().into())?;
            ...
            //todo impl annotations.
            let annotations = JavaValue::Object(Some(
                jvm.allocate_object(Object::Array(ArrayObject::new_array(
                    ...
                    CPDType::ByteType,
                    jvm.thread_state
                        .new_monitor("monitor for annotations array".to_string()),
                )?)),
            ));
...
pub mod constant_pool {
    ...
    impl<'gc_life> ConstantPool<'gc_life> {
        pub fn new(
            jvm: &'gc_life JVMState<'gc_life>,
            int_state: &'_ mut InterpreterStateGuard<'gc_life, 'l>,
            class: JClass<'gc_life>,
        ) -> Result<ConstantPool<'gc_life>, WasException> {
            let constant_pool_classfile =
                check_initing_or_inited_class(jvm, int_state, CClassName::constant_pool().into())?;
        ...
        pub fn get_constant_pool_oop(&self, jvm: &'gc_life JVMState<'gc_life>) -> JClass<'gc_life> {
            self.normal_object
                .lookup_field(jvm, FieldName::field_constantPoolOop())
                .cast_class()
                .unwrap()
        }
        ...
        pub fn set_constant_pool_oop(&self, jclass: JClass<'gc_life>) {
            self.normal_object
                ...
                .set_var_top_level(FieldName::field_constantPoolOop(), jclass.java_value());
        }
