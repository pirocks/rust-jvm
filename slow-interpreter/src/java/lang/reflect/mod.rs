...
pub mod constructor {
    ...
    impl Constructor {
        ...
        pub fn new_constructor(
            ...
            let constructor_class = check_inited_class(jvm, int_state, ClassName::constructor().into()).unwrap();
            //todo impl these
...
pub mod field {
    ...
    impl Field {
        pub fn init(
            ...
            let field_classfile = check_inited_class(jvm, int_state, ClassName::field().into()).unwrap();
