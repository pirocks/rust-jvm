macro_rules! as_object_or_java_value {
    () => {
        //todo this should take gc_life as a param
        ...
        pub fn to_string(&self, jvm: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'l mut crate::InterpreterStateGuard<'l,'gc_life>) -> Result<Option<crate::java::lang::string::JString<'gc_life>>,crate::WasException> {
            int_state.current_frame_mut().push(JavaValue::Object(todo!()/*self.normal_object.clone().into()*/));
        ...
        pub fn get_class(&self, state: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'l mut crate::InterpreterStateGuard<'l,'gc_life>) -> Result<crate::java::lang::class::JClass<'gc_life>,crate::WasException> {
            int_state.current_frame_mut().push(JavaValue::Object(todo!()/*self.normal_object.clone().into()*/));
        ...
        pub fn hash_code(&self, state: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'l mut crate::InterpreterStateGuard<'l,'gc_life>) -> Result<i32,crate::WasException> {
            int_state.current_frame_mut().push(JavaValue::Object(todo!()/*self.normal_object.clone().into()*/));
