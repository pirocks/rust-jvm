macro_rules! as_object_or_java_value {
    () => {
        ...
        pub fn to_string(&self, state: &'static crate::JVMState, frame: &crate::stack_entry::StackEntry) -> crate::java::lang::string::JString {
        ...
        pub fn get_class(&self, state: &'static crate::JVMState, frame: &crate::stack_entry::StackEntry) -> crate::java::lang::class::JClass {
            frame.push(JavaValue::Object(self.normal_object.clone().into()));
        ...
        pub fn hash_code(&self, state: &'static crate::JVMState, frame: &crate::stack_entry::StackEntry) -> i32 {
            frame.push(JavaValue::Object(self.normal_object.clone().into()));
