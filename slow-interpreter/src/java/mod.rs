...
pub trait NewAsObjectOrJavaValue<'gc_life>: Sized {
    ...
    fn get_class<'l>(&self, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life,'l>) -> Result<JClass<'gc_life>, WasException> {
    ...
    fn hash_code<'l>(&self, jvm: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'_ mut crate::InterpreterStateGuard<'gc_life,'l>) -> Result<i32, crate::WasException> {
    ...
    fn to_string<'l>(&self, jvm: &'gc_life JVMState<'gc_life>, int_state: &'_ mut InterpreterStateGuard<'gc_life,'l>) -> Result<Option<JString<'gc_life>>, WasException> {
...
macro_rules! as_object_or_java_value {
    () => {
        ...
        pub fn to_string<'l>(&self, jvm: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'_ mut crate::InterpreterStateGuard<'gc_life,'l>) -> Result<Option<crate::java::lang::string::JString<'gc_life>>, crate::WasException> {
            todo!();/*int_state.current_frame_mut().push(JavaValue::Object(self.normal_object.clone().into()));*/
            let desc = rust_jvm_common::compressed_classfile::CMethodDescriptor {
                arg_types: vec![],
        ...
        pub fn get_class<'l>(&self, jvm: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'_ mut crate::InterpreterStateGuard<'gc_life,'l>) -> Result<crate::java::lang::class::JClass<'gc_life>, crate::WasException> {
            todo!();/*int_state.current_frame_mut().push(JavaValue::Object(self.normal_object.clone().into()));*/
            let desc = rust_jvm_common::compressed_classfile::CMethodDescriptor {
                arg_types: vec![],
                return_type: rust_jvm_common::compressed_classfile::CPDType::Ref(rust_jvm_common::compressed_classfile::CPRefType::Class(rust_jvm_common::compressed_classfile::names::CClassName::class())),
        ...
        pub fn hash_code<'l>(&self, jvm: &'gc_life crate::jvm_state::JVMState<'gc_life>, int_state: &'_ mut crate::InterpreterStateGuard<'gc_life,'l>) -> Result<i32, crate::WasException> {
            todo!();/*int_state.current_frame_mut().push(JavaValue::Object(self.normal_object.clone().into()));*/
