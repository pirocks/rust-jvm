...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_arrayBaseOffset(
    env: *mut JNIEnv,
    obj: jobject,
    cb: jclass,
) -> jint {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_staticFieldBase(
    env: *mut JNIEnv,
    field: jobject,
) -> jobject {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_arrayIndexScale(
    env: *mut JNIEnv,
    obj: jobject,
    cb: jclass,
) -> jint {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_reflect_Reflection_getCallerClass(
    env: *mut JNIEnv,
    cb: jclass,
) -> jclass {
...
unsafe extern "system" fn Java_sun_misc_Unsafe_copyMemory(
    ...
    libc::memcpy(
        transmute(address),
        src_buffer.as_ptr() as *const libc::c_void,
        len as usize,
    );
}

#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putByte__JB(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    address: jlong,
    byte_: jbyte,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putInt__JI(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    address: jlong,
    int_: jint,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_objectFieldOffset(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    field_obj: jobject,
) -> jlong {
    ...
    let name = FieldName(
        jvm.string_pool
            .add_name(jfield.name(jvm).to_rust_string(jvm), false),
    );
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_staticFieldOffset(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    field_obj: jobject,
) -> jlong {
    ...
    match from_object(jvm, obj) {
        Some(notnull) => {
            ...
            notnull
                ...
                .get_var_top_level(jvm, field_name)
                .unwrap_int()
        }
        None => {
            //static
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_allocateMemory(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    len: jlong,
) -> jlong {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putLong__JJ(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    ptr: jlong,
    val: jlong,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getByte__J(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    ptr: jlong,
) -> jbyte {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getInt__J(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    ptr: jlong,
) -> i32 {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getLong__J(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    ptr: jlong,
) -> i64 {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getLongVolatile(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    offset: jlong,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getLong__Ljava_lang_Object_2J(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    offset: jlong,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_freeMemory(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    ptr: jlong,
) {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_getObjectVolatile(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    field_id_and_array_idx: jlong,
) -> jobject {
    let jvm = get_state(env);
    match from_object(jvm, obj) {
        None => {
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putObjectVolatile(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    offset: jlong,
        ...
        Some(object_to_read) => match object_to_read.deref() {
            Object::Array(arr) => {
                ...
                arr.set_i(
                    jvm,
                    array_idx as i32,
                    JavaValue::Object(from_object(jvm, to_put)),
                );
            }
            Object::Object(obj) => {
                let field_id = offset as FieldId;
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putObject(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    offset: jlong,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_putOrderedObject(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    obj: jobject,
    offset: jlong,
...
#[no_mangle]
unsafe extern "system" fn Java_sun_misc_Unsafe_setMemory(
    env: *mut JNIEnv,
    the_unsafe: jobject,
    o: jobject,
    offset: jlong,
