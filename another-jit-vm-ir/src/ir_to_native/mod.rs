...
use another_jit_vm::{DoubleRegister, FloatRegister, JITContext, Register, VMState};
...
fn ir_call_intrinsic_helper(assembler: &mut CodeAssembler, intrinsic_helper_type: IntrinsicHelperType, integer_args: &Vec<Register>, integer_res: Option<Register>, float_args: &Vec<FloatRegister>, float_res: &Option<FloatRegister>, double_args: &Vec<DoubleRegister>, double_res: &Option<DoubleRegister>) {
