...
pub(crate) enum PredefinedStrings {
    ...
    method_putFloat,
    method_putDouble,
    method_getObjectVolatile,
    method_getBooleanVolatile,
    method_getByteVolatile,
    method_getShortVolatile,
    method_getCharVolatile,
    method_getLongVolatile,
    method_getFloatVolatile,
    method_getDoubleVolatile,
    method_putIntVolatile,
    method_putObjectVolatile,
    method_putBooleanVolatile,
    method_putByteVolatile,
    method_putShortVolatile,
    method_putCharVolatile,
...
impl PredefinedStrings {
    pub fn underlying_string(&self) -> String {
        match self {
            ...
            method_getInt => "getInt".to_string(),
            method_getObject => "getObject".to_string(),
            method_getBoolean => "getBoolean".to_string(),
            method_getShort => "getShort".to_string(),
            method_getChar => "getChar".to_string(),
            method_getFloat => "getFloat".to_string(),
            method_getDouble => "getDouble".to_string(),
            method_putInt => "putInt".to_string(),
            method_putObject => "putObject".to_string(),
            method_putBoolean => "putBoolean".to_string(),
            method_putByte => "putByte".to_string(),
            method_putShort => "putShort".to_string(),
            method_putChar => "putChar".to_string(),
            method_putFloat => "putFloat".to_string(),
            method_putDouble => "putDouble".to_string(),
            method_getObjectVolatile => "getObjectVolatile".to_string(),
            method_getBooleanVolatile => "getBooleanVolatile".to_string(),
            method_getByteVolatile => "getByteVolatile".to_string(),
            method_getShortVolatile => "getShortVolatile".to_string(),
            method_getCharVolatile => "getCharVolatile".to_string(),
            method_getLongVolatile => "getLongVolatile".to_string(),
            method_getFloatVolatile => "getFloatVolatile".to_string(),
            method_getDoubleVolatile => "getDoubleVolatile".to_string(),
            method_putIntVolatile => "putIntVolatile".to_string(),
            method_putObjectVolatile => "putObjectVolatile".to_string(),
            method_putBooleanVolatile => "putBooleanVolatile".to_string(),
            method_putByteVolatile => "putByteVolatile".to_string(),
            method_putShortVolatile => "putShortVolatile".to_string(),
            method_putCharVolatile => "putCharVolatile".to_string(),
            ...
            method_sqrt => "sqrt".to_string(),
            JAVA_LANG_STRICT_MATH => "java/lang/StrictMath".to_string(),
            method_sin => "sin".to_string(),
            method_cos => "cos".to_string(),
            method_tan => "tan".to_string(),
            method_asin => "asin".to_string(),
            method_acos => "acos".to_string(),
            method_atan => "atan".to_string(),
            method_exp => "exp".to_string(),
            method_log => "log".to_string(),
            method_log10 => "log10".to_string(),
            method_cbrt => "cbrt".to_string(),
            method_IEEEremainder => "IEEEremainder".to_string(),
            method_atan2 => "atan2".to_string(),
            method_pow => "pow".to_string(),
            method_sinh => "sinh".to_string(),
            method_cosh => "cosh".to_string(),
            method_tanh => "tanh".to_string(),
