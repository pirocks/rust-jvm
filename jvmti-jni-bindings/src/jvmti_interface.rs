...
use crate::{jboolean, jclass, jdouble, jfieldID, jfloat, jint, jlocation, jlong, jmethodID, jniNativeInterface, jobject, jrawMonitorID, jthread, jthreadGroup, jvmtiCapabilities, jvmtiClassDefinition, jvmtiEnv, jvmtiError, jvmtiEvent, jvmtiEventCallbacks, jvmtiEventMode, jvmtiExtensionEvent, jvmtiExtensionEventInfo, jvmtiExtensionFunctionInfo, jvmtiFrameInfo, jvmtiHeapCallbacks, jvmtiHeapObjectCallback, jvmtiHeapObjectFilter, jvmtiHeapRootCallback, jvmtiJlocationFormat, jvmtiLineNumberEntry, jvmtiLocalVariableEntry, jvmtiMonitorStackDepthInfo, jvmtiMonitorUsage, jvmtiObjectReferenceCallback, jvmtiPhase, jvmtiStackInfo, jvmtiStackReferenceCallback, jvmtiStartFunction, jvmtiThreadGroupInfo, jvmtiThreadInfo, jvmtiTimerInfo, jvmtiVerboseFlag};

#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct JVMTIInterfaceNamedReservedPointers {
    pub jvm_state: *mut c_void,//jvm state
    ...
    pub current_native_frame: *mut c_void,// current native frame
    ...
    pub RunAgentThread: Option<unsafe extern "C" fn(env: *mut jvmtiEnv, thread: jthread, proc_: jvmtiStartFunction, arg: *const c_void, priority: jint) -> jvmtiError>,
