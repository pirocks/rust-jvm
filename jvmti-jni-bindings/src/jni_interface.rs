...
use crate::{__va_list_tag, jarray, JavaVM, jboolean, jbooleanArray, jbyte, jbyteArray, jchar, jcharArray, jclass, jdouble, jdoubleArray, jfieldID, jfloat, jfloatArray, jint, jintArray, jlong, jlongArray, jmethodID, JNIEnv, JNINativeMethod, jobject, jobjectArray, jobjectRefType, jshort, jshortArray, jsize, jstring, jthrowable, jvalue, jweak};

pub type JNIEnvNamedReservedPointers = *const JNINativeInterfaceNamedReservedPointers;

#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct JNINativeInterfaceNamedReservedPointers {
    pub jvm_state: *mut c_void,
    pub native_frame: *mut c_void,
    pub was_exception: *mut c_void,
    ...
    pub NewLocalRef: Option<unsafe extern "C" fn(env: *mut JNIEnv, ref_: jobject) -> jobject>,
    ...
    pub NewObjectV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jobject>,
    ...
    pub CallObjectMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jobject>,
    ...
    pub CallBooleanMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jboolean>,
    ...
    pub CallByteMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jbyte>,
    ...
    pub CallCharMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jchar>,
    ...
    pub CallShortMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jshort>,
    ...
    pub CallIntMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jint>,
    ...
    pub CallLongMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jlong>,
    ...
    pub CallFloatMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jfloat>,
    ...
    pub CallDoubleMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag) -> jdouble>,
    ...
    pub CallVoidMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *mut __va_list_tag)>,
    ...
    pub CallNonvirtualObjectMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jobject>,
    ...
    pub CallNonvirtualBooleanMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jboolean>,
    ...
    pub CallNonvirtualByteMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jbyte>,
    ...
    pub CallNonvirtualCharMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jchar>,
    ...
    pub CallNonvirtualShortMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jshort>,
    ...
    pub CallNonvirtualIntMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jint>,
    ...
    pub CallNonvirtualLongMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jlong>,
    ...
    pub CallNonvirtualFloatMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jfloat>,
    ...
    pub CallNonvirtualDoubleMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jdouble>,
    ...
    pub CallNonvirtualVoidMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag)>,
    ...
    pub CallStaticObjectMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jobject>,
    ...
    pub CallStaticBooleanMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jboolean>,
    ...
    pub CallStaticByteMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jbyte>,
    ...
    pub CallStaticCharMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jchar>,
    ...
    pub CallStaticShortMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jshort>,
    ...
    pub CallStaticIntMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jint>,
    ...
    pub CallStaticLongMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jlong>,
    ...
    pub CallStaticFloatMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jfloat>,
    ...
    pub CallStaticDoubleMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *mut __va_list_tag) -> jdouble>,
    ...
    pub CallStaticVoidMethodV: Option<unsafe extern "C" fn(env: *mut JNIEnv, cls: jclass, methodID: jmethodID, args: *mut __va_list_tag)>,
    ...
    pub GetStringLength: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring) -> jsize>,
    pub GetStringChars: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, isCopy: *mut jboolean) -> *const jchar>,
    pub ReleaseStringChars: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, chars: *const jchar)>,
    pub NewStringUTF: Option<unsafe extern "C" fn(env: *mut JNIEnv, utf: *const c_char) -> jstring>,
    pub GetStringUTFLength: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring) -> jsize>,
    pub GetStringUTFChars: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, isCopy: *mut jboolean) -> *const c_char>,
    pub ReleaseStringUTFChars: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, chars: *const c_char)>,
    ...
    pub GetStringRegion: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, start: jsize, len: jsize, buf: *mut jchar)>,
    pub GetStringUTFRegion: Option<unsafe extern "C" fn(env: *mut JNIEnv, str_: jstring, start: jsize, len: jsize, buf: *mut c_char)>,
    ...
    pub DeleteWeakGlobalRef: Option<unsafe extern "C" fn(env: *mut JNIEnv, ref_: jweak)>,
