...
//
//pub fn load_class(jvm_state: &mut JVMState, loader: Arc<dyn Loader + Send + Sync>, to_load: ClassEntry, only_verify: bool) {
...
//}
//
//fn bootstrap_load(jvm_state: &mut JVMState, loader: Arc<dyn Loader + Send + Sync>, to_load: &ClassEntry, only_verify: bool) {
//    bootstrap_load_impl(jvm_state, loader, to_load, only_verify, &mut HashMap::new());
//}
//
//fn bootstrap_load_impl(jvm_state: &mut JVMState, loader: Arc<dyn Loader + Send + Sync>, to_load: &ClassEntry, only_verify: bool, loading: &mut HashMap<ClassEntry, Arc<Classfile>>) {
