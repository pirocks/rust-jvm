...
//
//pub fn load_class(jvm_state: &'static JVMState, loader: LoaderArc, to_load: ClassEntry, only_verify: bool) {
...
//}
//
//fn bootstrap_load(jvm_state: &'static JVMState, loader: LoaderArc, to_load: &ClassEntry, only_verify: bool) {
//    bootstrap_load_impl(jvm_state, loader, to_load, only_verify, &mut HashMap::new());
//}
//
//fn bootstrap_load_impl(jvm_state: &'static JVMState, loader: LoaderArc, to_load: &ClassEntry, only_verify: bool, loading: &mut HashMap<ClassEntry, Arc<Classfile>>) {
