...
//    dbg!(get_class(vf,method.class).methods[method.method_index].method_name(&get_class(vf,method.class)));
//    dbg!(get_class(vf,method.class).methods[method.method_index].descriptor_str(&get_class(vf,method.class)));
