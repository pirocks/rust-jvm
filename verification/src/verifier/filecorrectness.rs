...
#[allow(unused)]
fn different_runtime_package(vf: &VerifierContext,class1: &ClassWithLoader, class2: &ClassWithLoader) -> bool {
...
fn different_package_name(_vf: &VerifierContext,_class1: &ClassWithLoader, _class2: &ClassWithLoader) -> bool {
    unimplemented!()
