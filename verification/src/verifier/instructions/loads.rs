...
pub fn instruction_is_type_safe_aaload(
    env: &Environment,
    stack_frame: Frame,
    ...
    let next_frame = valid_type_transition(
        env,
        vec![VType::IntType, object_array],
        component_type,
        stack_frame,
    )?;
...
pub fn instruction_is_type_safe_lload(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_aload(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_baload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    let array_type = nth1_operand_stack_is(2, &stack_frame)?;
    ...
    type_transition(
        env,
        stack_frame,
        vec![VType::IntType, VType::TopType],
        VType::IntType,
    )
}

pub fn instruction_is_type_safe_caload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
        env,
        stack_frame,
        vec![VType::IntType, VType::ArrayReferenceType(CPDType::CharType)],
        VType::IntType,
    )
}

pub fn instruction_is_type_safe_daload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    type_transition(
        env,
        stack_frame,
        vec![VType::IntType, array_type],
        VType::DoubleType,
    )
}

pub fn instruction_is_type_safe_dload(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_faload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_fload(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_iaload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
        env,
        stack_frame,
        vec![VType::IntType, VType::ArrayReferenceType(CPDType::IntType)],
        VType::IntType,
    )
}

pub fn instruction_is_type_safe_iload(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_laload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_saload(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
