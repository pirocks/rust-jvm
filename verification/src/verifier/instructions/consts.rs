...
pub fn instruction_is_type_safe_iconst_m1(
    env: &Environment,
    stack_frame: Frame,
...
pub fn instruction_is_type_safe_lconst_0(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_aconst_null(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_dconst_0(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_fconst_0(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
