...
pub fn modify_local_variable(
    vf: &VerifierContext,
    index: u16,
    type_: VType,
    locals: &[VType],
) -> Result<Vec<VType>, TypeSafetyError> {
...
pub fn instruction_is_type_safe_aastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    let object = ClassWithLoader {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![object_type, VType::IntType, object_array],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_astore(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_bastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![VType::IntType, VType::IntType, VType::TopType],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}
...
pub fn instruction_is_type_safe_castore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    let locals = stack_frame.locals.clone();
    ...
    let next_frame = can_pop(
        ...
        vec![
            VType::IntType,
            VType::IntType,
            VType::ArrayReferenceType(CPDType::CharType),
        ],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_dastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![VType::DoubleType, VType::IntType, array_type],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_dstore(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_fastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![VType::FloatType, VType::IntType, array_type],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_fstore(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_iastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![VType::IntType, VType::IntType, array_type],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_istore(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_lastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    ...
    let next_frame = can_pop(
        &env.vf,
        stack_frame,
        vec![VType::LongType, VType::IntType, array_type],
    )?;
    standard_exception_frame(locals, flag, next_frame)
}

pub fn instruction_is_type_safe_lstore(
    index: u16,
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_sastore(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
