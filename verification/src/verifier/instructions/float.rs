...
pub fn instruction_is_type_safe_d2f(
    env: &Environment,
    stack_frame: Frame,
...
pub fn instruction_is_type_safe_d2i(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_d2l(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_dadd(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
        env,
        stack_frame,
        vec![VType::DoubleType, VType::DoubleType],
        VType::DoubleType,
    )
}

pub fn instruction_is_type_safe_dcmpg(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
...
pub fn instruction_is_type_safe_dneg(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_f2d(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_f2i(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_f2l(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
...
pub fn instruction_is_type_safe_fadd(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
        env,
        stack_frame,
        vec![VType::FloatType, VType::FloatType],
        VType::FloatType,
    )
}

pub fn instruction_is_type_safe_fcmpg(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
    type_transition(
...
pub fn instruction_is_type_safe_fneg(
    env: &Environment,
    stack_frame: Frame,
) -> Result<InstructionTypeSafe, TypeSafetyError> {
