...
instructionIsTypeSafe(invokespecial(CP), Environment, _Offset, StackFrame,
    ...
    currentClassLoader(Environment, CurrentLoader),
    rewrittenUninitializedType(uninitializedThis, Environment, class(MethodClassName, CurrentLoader), This),
...
instructionIsTypeSafe(invokespecial(CP), Environment, _Offset, StackFrame,
    ...
    currentClassLoader(Environment, CurrentLoader),
    rewrittenUninitializedType(uninitialized(Address), Environment,class(MethodClassName, CurrentLoader), This),
